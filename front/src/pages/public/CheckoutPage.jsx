...
export default function CheckoutPage() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            // ✅ AHORA INCLUYE TODOS LOS CAMPOS DEL FORMULARIO
            const orderData = {
                userId: user.id,
                items: cart.map(item => ({
                    productId: item.id,
            ...
            console.log('📝 orderData enviado:', JSON.stringify(orderData, null, 2))
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        <div className="bg-white border border-outline-variant rounded-lg p-6">
                            ...
                            <div className="space-y-4">
                                ...
                                <div>
                                    <label className="block text-sm font-bold text-gray-700 mb-2 uppercase">Código Postal</label>
                                    <input type="text" name="postalCode" value={formData.postalCode} onChange={handleChange} className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary focus:border-primary outline-none transition" />
                                </div>
                            </div>
                        </div>
