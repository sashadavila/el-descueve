...
export default function AdminProducts() {
    ...
    const loadStats = async () => {
        try {
            const statsData = await api.products.getStats()
            setStats(statsData)
        } catch (error) {
        ...
        <div className="space-y-6">
            ...
            {stats && (
                <div className="grid grid-cols-2 md:grid-cols-6 gap-4">
                    ...
                    <div className="bg-white p-4 rounded-lg border">
                        <p className="text-xs text-gray-500">Corporativo</p>
                        <p className="text-xl font-bold text-blue-600">{stats.byType?.corporativo || 0}</p>
                    </div>
                    <div className="bg-white p-4 rounded-lg border">
                        <p className="text-xs text-gray-500">Industrial</p>
                        <p className="text-xl font-bold text-orange-600">{stats.byType?.industrial || 0}</p>
                    </div>
                    <div className="bg-white p-4 rounded-lg border">
                        <p className="text-xs text-gray-500">Bordados</p>
                        <p className="text-xl font-bold text-purple-600">{stats.byType?.bordados || 0}</p>
                    </div>
                    <div className="bg-white p-4 rounded-lg border">
                            ...
                            {uploadResult ? (
                                                ...
                                                <details className="mt-3">
                                                    ...
                                                    <ul className="mt-2 text-xs text-red-500 list-disc pl-4">
                                                        ...
                                                        {uploadResult.errors.length > 10 && (
                                                            <li>... y {uploadResult.errors.length - 10} más</li>
                                                        )}
                                                    </ul>
                                                </details>
                                            )}
                                ...
                                <>
                                    ...
                                    <div className="bg-blue-50 p-4 rounded-lg mb-4">
                                        ...
                                        <p className="text-xs text-blue-600 mb-2">Columnas requeridas: <strong>name, reference, price</strong></p>
                                        <p className="text-xs text-blue-600">Columnas opcionales: description, productType, category, sizes, colors, stock, imageUrl, isFeatured, discount, features</p>
                                    </div>
